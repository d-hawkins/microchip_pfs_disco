...
\clearpage
\input{sections/fabric_blinky.tex}
\clearpage
\input{sections/riscv_blinky.tex}
\clearpage
\input{sections/linux_boot.tex}
\clearpage
...
02/23/2026  & Corrected MUX bit index and GPIO address in Section 5.5.\\
&\\
\hline
\end{tabular}
\end{center}
